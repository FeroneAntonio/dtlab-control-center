...
Il bundle in `lab/beerfactory-company/` è materiale di laboratorio fornito
...
Gli scenari e gli strumenti di detection sono destinati esclusivamente a sistemi
propri o esplicitamente autorizzati. DTLab non avvia automaticamente gli script di
laboratorio e le regole incluse sono alert-only.
